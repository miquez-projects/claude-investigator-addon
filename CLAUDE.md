...
2. HA calls the add-on's `/investigate` endpoint or runs `/investigate.sh` directly
3. Script clones/updates the repo, optionally connects to phone via ADB/Tailscale
4. Claude Code runs in print mode with limited tools to investigate
5. Findings posted as issue comment; draft PR created if confident
